    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-16">
        ...
        <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-foreground text-center mb-2 leading-[1.1]">
          Ship social proof in <span className="font-serif italic text-primary">minutes</span>.
        </h1>
        <p className="text-muted-foreground text-center mb-8">Free forever plan. No credit card required.</p>
        <SignUp />
      </div>
    </div>
  );
