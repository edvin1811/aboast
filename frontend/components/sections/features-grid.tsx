  ...
  return (
    <section id="features" className="w-full max-w-6xl mx-auto mt-32 px-6 grid grid-cols-1 md:grid-cols-3 gap-6">
      {CARDS.map(({ icon: Icon, title, body, visual }) => (
        <div
          key={title}
          className="relative overflow-hidden group bg-white border border-border hover:border-neutral-300 rounded-3xl p-8 flex flex-col min-h-[420px] transition-all duration-300 shadow-[0_1px_2px_rgba(15,15,15,0.04),0_8px_24px_-12px_rgba(15,15,15,0.08)]"
        >
          {/* Inner ambient glow */}
